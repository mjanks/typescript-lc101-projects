...
console.log("".concat(spaceShuttle.name, " will take ").concat(spaceShuttle.getDaysToLocation(kilometersToMars), " days to reach Mars."));
console.log("".concat(spaceShuttle.name, " will take ").concat(spaceShuttle.getDaysToLocation(kilometersToTheMoon), " days to reach The Moon."));
